 ...
 */
class Destinatario extends \AppBundle\Entity\Destinatario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Destinatario' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Destinatario' . "\0" . 'apellidos', '' . "\0" . 'AppBundle\\Entity\\Destinatario' . "\0" . 'nombres', '' . "\0" . 'AppBundle\\Entity\\Destinatario' . "\0" . 'notas'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Destinatario $proxy) {

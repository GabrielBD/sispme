 ...
 */
class EstadoNota extends \AppBundle\Entity\EstadoNota implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\EstadoNota' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\EstadoNota' . "\0" . 'estado', '' . "\0" . 'AppBundle\\Entity\\EstadoNota' . "\0" . 'notas'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EstadoNota $proxy) {

 ...
 */
class UsuarioExterno extends \AppBundle\Entity\UsuarioExterno implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\UsuarioExterno' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\UsuarioExterno' . "\0" . 'apellidos', '' . "\0" . 'AppBundle\\Entity\\UsuarioExterno' . "\0" . 'nombres', '' . "\0" . 'AppBundle\\Entity\\UsuarioExterno' . "\0" . 'domicilio', '' . "\0" . 'AppBundle\\Entity\\UsuarioExterno' . "\0" . 'celular', '' . "\0" . 'AppBundle\\Entity\\UsuarioExterno' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\UsuarioExterno' . "\0" . 'tutor', '' . "\0" . 'AppBundle\\Entity\\UsuarioExterno' . "\0" . 'hijo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UsuarioExterno $proxy) {
    ...
    public function setHijo(\AppBundle\Entity\Postulante $hijo = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHijo', [$hijo]);

        return parent::setHijo($hijo);
    }
    ...
    public function getHijo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHijo', []);

        return parent::getHijo();
    }
